  ...
  protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
    ...
    if (Objects.isNull(ex.getCause())) {
      ...
      if (ife.getTargetType() != null && ife.getTargetType().getEnumConstants() != null) {
        ...
        errors.add(messageError.create(Messages.FIELD_VALIDATION,
            format("Tipo inválido para o campo '%s' - Valores disponíveis '%s'.",
        ...
        errors.add(messageError.create(Messages.FIELD_VALIDATION,
            format("Tipo inválido para o campo '%s' - Tipo '%s' esperado.", ife.getPath().stream().map(
                p -> Objects.nonNull(p.getFieldName()) ? p.getFieldName() : "[" + p.getIndex() + "]")
      ...
      errors.add(messageError.create(Messages.FIELD_VALIDATION,
          format("Tipo inválido para o campo '%s' - Tipo '%s' esperado.",
  ...
  protected ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, HttpHeaders headers,
    ...
    if (ex instanceof MethodArgumentTypeMismatchException) {
      ...
      if (mtme.getRequiredType().getEnumConstants() != null) {
        ...
        errors.add(messageError.create(Messages.FIELD_VALIDATION,
            format("%s não é valido '%s' - Valores disponíveis '%s'.",
                mtme.getValue(),
                mtme.getName(),
                availableValues)));
      } else {
